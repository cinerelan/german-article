document.addEventListener('DOMContentLoaded', function() {
    ...
    themeBtn.addEventListener('click', function() {
        ...
        if (themeBtn.classList.contains('d-theme')) {
            themeBtn.classList.remove('d-theme');
            themeBtn.classList.add('l-theme');
            document.querySelector("span.sun-icon").style.display = "none";
            ...
            document.body.classList.add('light-theme');
                ...
                themeBtn.classList.remove('l-theme');
                themeBtn.classList.add('d-theme');

                document.querySelector("span.sun-icon").style.display = "block";
